 ...
 *
 * Falls back to rdap.org when who-dat is unavailable.
 *
 * Workers-compatible: only uses fetch. The legacy `whois-json` Node-only fallback
 * has been removed (Workers can't import npm packages at runtime).
 */
